...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var createItem = function createItem(itemText, index) {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'a',
	          { style: { color: '#600', cursor: 'pointer' }, onClick: function () {
	...
	var TodoApp = _react2['default'].createClass({
	  ...
	  getInitialState: function getInitialState() {
	    ...
	    (0, _state.subscribe)(function () {
	      _this2.setState({ items: _state2['default'].items });
	    });
	  ...
	  handleSubmit: function handleSubmit(e) {
	    ...
	    // var nextText = '';
	    (0, _state.addItem)(this.state.text);
