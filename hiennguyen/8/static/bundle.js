...
/******/ 	var hotCurrentHash = "ef62453e91dfaeb2ba4d"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _drawer = __webpack_require__(159);
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'select',
	        { defaultValue: 'line', onChange: this.changeMode },
	        _react2['default'].createElement(
	          'option',
	          { value: 'line' },
	          'Line'
	      ...
	      _react2['default'].createElement(
	        'select',
	        { defaultValue: 'black', onChange: this.changeColor },
	        _react2['default'].createElement(
	          'option',
	          { value: 'black' },
	          'Black'
	      ...
	      _react2['default'].createElement(
	        'button',
	        { ref: 'clear', onClick: this.clear },
	        'Clear'
	      ),
	      _react2['default'].createElement(_drawer2['default'], { ref: 'canvas', color: this.state.color, mode: this.state.mode })
	    );
	  }
	});
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  mousemove: function mousemove(e) {
	    if (this.state.mousePressed) {
	      this.drawAll();
	      var d = this.refs.canvas;
	      this.draw(this.state.first.x, this.state.first.y, e.pageX - d.offsetLeft, e.pageY - d.offsetTop, this.props.color, this.props.mode);
	  ...
	  draw: function draw(x1, y1, x2, y2, color, mode) {
	  ...
	  drawAll: function drawAll() {
	    ...
	    for (var i = 0; i < this.state.end.length; i++) {
	      this.draw(this.state.start[i].x, this.state.start[i].y, this.state.end[i].x, this.state.end[i].y, this.state.colors[i], this.state.modes[i]);
	    }
	  },
	  clear: function clear() {
	    var ctx = this.state.ctx;
	  ...
	  render: function render() {
	    return _react2['default'].createElement('canvas', { width: 1200, height: 600, onMouseDown: this.mousedown, onMouseMove: this.mousemove,
