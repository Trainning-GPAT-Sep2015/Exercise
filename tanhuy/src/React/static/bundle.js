...
/***/ function(module, exports, __webpack_require__) {
	...
	var _draw_logic = __webpack_require__(159);
	...
	var Canvas = _react2['default'].createClass({
		...
		componentDidMount: function componentDidMount() {
			_draw_logic.state.context = this.refs.canvas.getContext("2d");
			console.log(this.refs.canvas.getContext('2d'));
		},
		mouseMove: function mouseMove(e) {
			(0, _draw_logic.mouseMove)(e.pageX - this.refs.canvas.offsetLeft, e.pageY - this.refs.canvas.offsetTop);
		},
		...
		mouseDown: function mouseDown(e) {
			(0, _draw_logic.mouseDown)(e.pageX - this.refs.canvas.offsetLeft, e.pageY - this.refs.canvas.offsetTop);
		},

		mouseUp: function mouseUp(e) {
			(0, _draw_logic.mouseUp)(e.pageX - this.refs.canvas.offsetLeft, e.pageY - this.refs.canvas.offsetTop);
		},

		clearCanvas: function clearCanvas() {
			(0, _draw_logic.clearCanvas)();
		},

		modeRect: function modeRect() {
			_draw_logic.state.mode = _draw_logic.RECT;
		},

		modeLine: function modeLine() {
			_draw_logic.state.mode = _draw_logic.LINE;
		},

		setColor: function setColor() {
			_draw_logic.state.color = this.refs.color.value;
			this.setState({});
		},
		...
		render: function render() {
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					...
					_draw_logic.state.colors.map(function (c) {
						return _react2['default'].createElement(
							'option',
							{ value: c },
							c.toUpperCase()
				...
				_react2['default'].createElement(
					'div',
					null,
					_react2['default'].createElement('canvas', { ref: 'canvas', onMouseMove: this.mouseMove, onMouseUp: this.mouseUp, onMouseDown: this.mouseDown, style: { width: "500", height: "250", border: "1px solid black" } })
				)
			);
		}
	...
	_reactDom2['default'].render(_react2['default'].createElement(Canvas, null), document.getElementById('app'));
